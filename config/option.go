...
import (
	...
	"github.com/khulnasoft-lab/gobaseline/database/record"
	"github.com/khulnasoft-lab/gobaseline/formats/dsd"
)
...
const (
	...
	DisplayHintAnnotation = "khulnasoft-lab/gobaseline:ui:display-hint"
	...
	// an number (int).
	DisplayOrderAnnotation = "khulnasoft-lab/gobaseline:ui:order"
	// UnitAnnotations defines the SI unit of an option (if any).
	UnitAnnotation = "khulnasoft-lab/gobaseline:ui:unit"
	...
	CategoryAnnotation = "khulnasoft-lab/gobaseline:ui:category"
	// SubsystemAnnotation can be used to mark an option as part
	// of a module subsystem.
	SubsystemAnnotation = "khulnasoft-lab/gobaseline:module:subsystem"
	...
	// future.
	StackableAnnotation = "khulnasoft-lab/gobaseline:options:stackable"
	...
	RestartPendingAnnotation = "khulnasoft-lab/gobaseline:options:restart-pending"
	...
	QuickSettingsAnnotation = "khulnasoft-lab/gobaseline:ui:quick-setting"
