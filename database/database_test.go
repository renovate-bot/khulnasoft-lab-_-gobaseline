...
import (
	...
	q "github.com/khulnasoft-lab/gobaseline/database/query"
	"github.com/khulnasoft-lab/gobaseline/database/record"
	"github.com/khulnasoft-lab/gobaseline/database/storage"
	_ "github.com/khulnasoft-lab/gobaseline/database/storage/badger"
	_ "github.com/khulnasoft-lab/gobaseline/database/storage/bbolt"
	_ "github.com/khulnasoft-lab/gobaseline/database/storage/fstree"
	_ "github.com/khulnasoft-lab/gobaseline/database/storage/hashmap"
)

func TestMain(m *testing.M) {
	testDir, err := os.MkdirTemp("", "gobaseline-database-testing-")
	if err != nil {
		panic(err)
	}
